...
public class LowestAverageGuessValid {
    ...
    public static void main (String[] args) throws InterruptedException, ExecutionException {
        ...
        //==========SET THESE==========
        int min=2500; int max=3000;
        //=============================
        List<LogObj> logObjList = new ArrayList<>();
        List<String> uniqueEqs = getEquationsUniqueChars();
    ...
    private static List<String> getEquationsUniqueChars() {
        List<String> eqs = Settings.EQUATION_GENERATOR.retrieveAllEquations();
    ...
    private static List<String> get3Eqs() {
        ...
        List<String> eqs = getEquationsUniqueChars();
